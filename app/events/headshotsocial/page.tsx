...
export default async function HeadshotSocialPage() {
  const folders = ['The Headshot Social']; 
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <main className="grow container mx-auto px-4 pt-32 pb-12">
        <Gallery mediaGroups={mediaGroups} title="The Headshot Social" backLink="/events" backLabel="Back to Events" />
      </main>
