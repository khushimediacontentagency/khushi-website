      ...
      <main className="grow flex flex-col md:flex-row">
        <Link href="/events/headshotsocial" className="flex-1 relative group overflow-hidden border-b md:border-b-0 md:border-r border-white/10 flex items-center justify-center min-h-[45vh] md:min-h-full">
          <div className="absolute inset-0 transition-transform duration-700 group-hover:scale-105">
            <Image src="/events/headshotsocial.jpeg" alt="The Headshot Social Background" fill className="object-cover" priority />
          </div>
          ...
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center w-full px-4">
            <div className="flex flex-col items-center justify-center w-full transition-transform duration-500 group-hover:scale-110">
              <div className="relative w-[60%] max-w-[350px] h-20 sm:h-28 md:w-[80%] md:h-[200px] z-20">
                <Image src="/headers/headshotsociallogo.png" alt="The Headshot Social Logo" fill className="object-contain" />
              </div>
              <p className="text-gray-200 text-center text-xs md:text-sm lg:text-base font-light tracking-widest w-full max-w-[400px] mt-2 sm:mt-0 md:-mt-6">
        ...
        <Link href="/events/createur" className="flex-1 relative group overflow-hidden border-b md:border-b-0 md:border-r border-white/10 flex items-center justify-center min-h-[45vh] md:min-h-full">
          <div className="absolute inset-0 transition-transform duration-700 group-hover:scale-105">
            <Image src="/events/createur.jpeg" alt="Createur Background" fill className="object-cover" priority />
          </div>
          <div className="absolute inset-0 bg-black/60 group-hover:bg-black/30 transition-colors duration-500"></div>
          
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center w-full px-4">
            <div className="flex flex-col items-center justify-center w-full transition-transform duration-500 group-hover:scale-110">
              <div className="relative w-[80%] max-w-[400px] h-20 sm:h-24 md:w-[85%] md:h-[140px] z-20">
                <Image src="/headers/createurlogo.png" alt="Createur Logo" fill className="object-contain" />
              </div>
              <p className="text-gray-200 text-center text-xs md:text-sm lg:text-base font-light tracking-widest w-full max-w-[400px] -mt-2">
        ...
        <Link href="/events/matchaclub" className="flex-1 relative group overflow-hidden flex items-center justify-center min-h-[45vh] md:min-h-full">
          <div className="absolute inset-0 transition-transform duration-700 group-hover:scale-105">
            <Image src="/events/matchacha.jpeg" alt="Matcha Club Background" fill className="object-cover" />
          </div>
          <div className="absolute inset-0 bg-black/60 group-hover:bg-black/30 transition-colors duration-500"></div>
          
          <div className="absolute inset-0 z-10 flex flex-col items-center justify-center w-full px-4 -translate-y-4 md:-translate-y-6">
            <div className="flex flex-col items-center justify-center w-full transition-transform duration-500 group-hover:scale-110 md:group-hover:scale-125">
              <div className="relative w-[60%] max-w-[400px] h-24 sm:h-32 md:w-[75%] md:h-[180px] z-20">
                <Image src="/headers/matchachalogo.png" alt="Matcha Club Logo" fill className="object-contain" />
              </div>
              <p className="text-gray-200 text-center text-xs md:text-sm lg:text-base font-light tracking-widest w-full max-w-[400px] -mt-6 sm:-mt-8 md:-mt-12">
