...
export default async function MatchaClubPage() {
  const folders = ['Matcha Club']; 
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <main className="grow container mx-auto px-4 pt-32 pb-12">
        <Gallery mediaGroups={mediaGroups} title="Matcha Club" backLink="/events" backLabel="Back to Events" />
      </main>
