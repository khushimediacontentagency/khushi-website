export default function AboutMe() {
  return (
    <section id="about-me" className="py-20 bg-white text-black">
      <div className="container mx-auto px-4 md:px-12 flex flex-col md:flex-row items-center justify-between gap-12">
