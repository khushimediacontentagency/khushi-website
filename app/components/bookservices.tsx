export default function BookServices() {
  const cardStyle = "group relative overflow-hidden rounded-2xl border border-white/10 bg-neutral-900 p-8 transition-all duration-500 hover:border-[#ff1267]/50 hover:shadow-2xl hover:shadow-[#ff1267]/10 md:w-1/2";
