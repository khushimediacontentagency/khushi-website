...
const useCardBackgroundColor = (imageSrc: string) => {
  const [color, setColor] = useState<string>('rgba(23, 23, 23, 1)'); 
...
export default function Brands() {
  ...
  return (
    <section id="brands" className="relative py-20 bg-neutral-950 overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 max-w-6xl mx-auto">
